...
def generate_pdf(content, image_path, output_path, topic):
    ...
    langchain_client = transalte.Client()
    translated_content = langchain_client.translate(content, "en", "es")
    
    
    translated_text = Paragraph(translated_content, styles["Normal"])
